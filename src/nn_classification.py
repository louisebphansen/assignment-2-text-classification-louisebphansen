...
def fit_and_predict(activation:str, hidden_layer_sizes:int, X_train: scipy.sparse._csr.csr_matrix, X_test: scipy.sparse._csr.csr_matrix, y_train: numpy.ndarray) -> numpy.ndarray:
    '''
